<<<<<<< HEAD
export function AdminOrders(){return (<div className="container" style={{padding:48,textAlign:'center'}}><h1 className="serif">AdminOrders</h1><p style={{color:'var(--muted)'}}>Later feature.</p></div>);}
=======

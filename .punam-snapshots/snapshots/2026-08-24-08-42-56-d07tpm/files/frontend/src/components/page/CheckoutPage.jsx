    ...
    <div className="container" style={{ padding: '40px 0 64px', maxWidth: 560, marginInline: 'auto' }}>
      ...
      {step === 2 && (<>
        <div style={{ background: 'var(--warning-soft)', borderRadius: 14, padding: 16, marginBottom: 16 }}>
          ...
          <p style={{ margin: '6px 0 0', color: 'var(--muted)', fontSize: 14 }}>{isP ? 'Once approved, pay with M-Pesa from My Shelf.' : 'After approval, pay the refundable deposit via M-Pesa on My Shelf — then your loan activates.'}</p>
        </div>

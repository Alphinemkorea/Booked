  ...
  return (
    <div className={`${styles.page} page-enter`}>
      ...
      <div className={styles.body}>
        ...
        {/* —— Landing: about · how it works · FAQ · contact —— */}
        <section className={styles.landingBlock} id="about">
          <div className={styles.landingGrid}>
            <div>
              <p className={styles.eyebrow}>About BOOKED</p>
              <h2 className={`serif ${styles.landingTitle}`}>A digital bookstore built for owning and borrowing</h2>
              <p className={styles.landingLead}>
                BOOKED is Kenya-first digital reading: buy a title and keep it on your shelf forever,
                or borrow from the library with a timed loan. Everything opens in your browser —
                no shipping, no wait for a physical copy.
              </p>
              <ul className={styles.bulletList}>
                <li><Store size={16} /> <span><strong>Shop</strong> — purchase digital ownership</span></li>
                <li><Library size={16} /> <span><strong>Library</strong> — request a loan, pay deposit, read until due</span></li>
                <li><BookMarked size={16} /> <span><strong>My Shelf</strong> — purchases, loans, wishlist, continue reading</span></li>
              </ul>
            </div>
            <div className={styles.featureCards}>
              <article className={`card ${styles.featureCard}`}>
                ...
                <p>Open a book the moment access is granted. No downloads required.</p>
              </article>
              <article className={`card ${styles.featureCard}`}>
                <Zap size={22} color="var(--primary)" />
                <h3>M-Pesa ready</h3>
                <p>Pay for approved orders and loan deposits with STK-style prompts.</p>
              </article>
              <article className={`card ${styles.featureCard}`}>
                <Shield size={22} color="var(--primary)" />
                <h3>Loans that expire cleanly</h3>
                <p>When time is up, access locks. Request a return and reclaim your deposit.</p>
              </article>
            </div>
          </div>
        </section>

        <section className={styles.landingBlock} id="how-it-works">
          <p className={styles.eyebrow}>How it works</p>
          <h2 className={`serif ${styles.landingTitle}`}>From discovery to reading in four steps</h2>
          <ol className={styles.steps}>
            <li><span className={styles.stepNum}>1</span><div><strong>Browse</strong><p>Explore Shop or Library. Guests can sample; members unlock full actions.</p></div></li>
            <li><span className={styles.stepNum}>2</span><div><strong>Add to a bag</strong><p>Purchase bag to own, or borrow bag for a timed loan request.</p></div></li>
            <li><span className={styles.stepNum}>3</span><div><strong>Approve & pay</strong><p>Orders and loans may need approval, then M-Pesa completes payment.</p></div></li>
            <li><span className={styles.stepNum}>4</span><div><strong>Read on Shelf</strong><p>Open the reader anytime for owned titles; loans until the due date.</p></div></li>
          </ol>
        </section>

        <section className={styles.landingBlock} id="faq">
          <p className={styles.eyebrow}>FAQ</p>
          <h2 className={`serif ${styles.landingTitle}`}>Common questions</h2>
          <div className={styles.faqList}>
            <details className={`card ${styles.faqItem}`} open>
              <summary>Is BOOKED a physical library?</summary>
              <p>No. BOOKED is digital-only. You read in the browser or app experience — nothing is shipped.</p>
            </details>
            <details className={`card ${styles.faqItem}`}>
              <summary>What is the difference between Shop and Library?</summary>
              <p>Shop means you pay to own the digital book permanently. Library means you request a loan, often with a refundable deposit, for a fixed number of days.</p>
            </details>
            <details className={`card ${styles.faqItem}`}>
              <summary>Do I need an account?</summary>
              <p>You can browse and sample as a guest. Buying, borrowing, wishlist, and full reading require a free account.</p>
            </details>
            <details className={`card ${styles.faqItem}`}>
              <summary>How do payments work?</summary>
              <p>After an order or loan is approved, you pay with M-Pesa. You will get a prompt on your phone to enter your PIN.</p>
            </details>
            <details className={`card ${styles.faqItem}`}>
              <summary>What happens when a loan ends?</summary>
              <p>Access locks automatically. You can request a return from My Shelf so the deposit can be refunded according to policy.</p>
            </details>
          </div>
        </section>

        <section className={styles.landingBlock} id="contact">
          <div className={`card ${styles.contactCard}`}>
            <div>
              <p className={styles.eyebrow}>Contact</p>
              <h2 className={`serif ${styles.landingTitle}`}>Talk to the BOOKED team</h2>
              <p className={styles.landingLead}>
                Questions about orders, loans, or partnerships? Reach out — we typically respond within one business day.
              </p>
              <ul className={styles.contactList}>
                <li><Mail size={18} /> <a href="mailto:hello@booked.ke">hello@booked.ke</a></li>
                <li><Phone size={18} /> <a href="tel:+254700000000">+254 700 000 000</a></li>
            ...
            <div className={styles.contactCtas}>
              ...
              <a className="btn btn-ghost" href="mailto:hello@booked.ke?subject=BOOKED%20support">Email support</a>
            </div>
          </div>
        </section>

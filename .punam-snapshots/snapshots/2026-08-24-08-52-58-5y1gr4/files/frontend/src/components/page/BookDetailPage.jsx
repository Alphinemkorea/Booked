        ...
        <div>
          ...
          >
            <div>
              ...
              <p style={{ margin: '0 0 10px', fontSize: 14, color: 'var(--muted)', lineHeight: 1.45 }}>Own the digital edition forever. Read online anytime — no shipping.</p>
            ...
            <div>
              ...
              <p style={{ margin: '0 0 10px', fontSize: 14, color: 'var(--muted)', lineHeight: 1.45 }}>Digital loan for {book.loanDays} days. Read in-browser; access locks when time ends.</p>
